...
const selectFieldSizes = (0,reselect_es/* createSelector */.P1)(selectAppDomain(), (state) => state.fieldSizes);
...
const CustomDragLayer = () => {
  ...
  return /* @__PURE__ */ react.createElement(components_LayoutDndProvider, null, /* @__PURE__ */ react.createElement("div", { style: layerStyles }, /* @__PURE__ */ react.createElement("div", { style: getItemStyles(initialOffset, currentOffset, mouseOffset), className: "col-md-2" }, [ItemTypes/* default.EDIT_FIELD */.Z.EDIT_FIELD, ItemTypes/* default.FIELD */.Z.FIELD].includes(itemType) && /* @__PURE__ */ react.createElement(components_CardPreview, { labelField: item.labelField }), actualType === ItemTypes/* default.COMPONENT */.Z.COMPONENT && /* @__PURE__ */ react.createElement(ComponentDragPreview, { displayedValue: item.displayedValue }), actualType === ItemTypes/* default.DYNAMIC_ZONE */.Z.DYNAMIC_ZONE && /* @__PURE__ */ react.createElement(ComponentDragPreview, { displayedValue: item.displayedValue }), actualType === ItemTypes/* default.RELATION */.Z.RELATION && /* @__PURE__ */ react.createElement(
    RelationDragPreview,
    {
...
const ModalForm = ({ onMetaChange, onSizeChange }) => {
  ...
  const schemasSelector = (0,react.useMemo)(makeSelectModelAndComponentSchemas, []);
  const { schemas } = (0,es/* useSelector */.v9)((state) => schemasSelector(state), es/* shallowEqual */.wU);
  const fieldSizes = (0,es/* useSelector */.v9)(selectFieldSizes);
...
function ReviewWorkflowsStageEE({ name }) {
  return /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "regular", textColor: "neutral700" }, name);
}
...
/* harmony default export */ const getTableColumn = ((layout) => {
  ...
  return {
    ...
    cellFormatter({ strapi_reviewWorkflows_stage }) {
      ...
      return /* @__PURE__ */ react.createElement(ReviewWorkflowsStage, { name: strapi_reviewWorkflows_stage.name });
    }
  };
});
...
function InformationBoxEE() {
  ...
  return /* @__PURE__ */ react.createElement(Information/* default.Root */.Z.Root, null, /* @__PURE__ */ react.createElement(Information/* default.Title */.Z.Title, null), hasReviewWorkflowsEnabled && !isCreatingEntry && /* @__PURE__ */ react.createElement(Field/* Field */.g, { error: formattedError, name: ATTRIBUTE_NAME, id: ATTRIBUTE_NAME }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", gap: 2, alignItems: "stretch" }, /* @__PURE__ */ react.createElement(FieldLabel/* FieldLabel */.Q, null, formatMessage({
    ...
    helper_plugin_esm/* ReactSelect */.JV,
    {
      ...
      options: workflow ? workflow.stages.map(({ id, name }) => ({ value: id, label: name })) : [],
